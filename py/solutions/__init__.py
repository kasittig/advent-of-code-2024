from .base import (
    BaseDailySolution as BaseDailySolution,  # pyright: ignore [reportUnusedImport]
)
...
from .day_10 import Day10Solution as Day10Solution  # pyright: ignore [reportUnusedImport]
